export const context = {
  '@context': {
    ...
    label: {
      '@id': 'http://localhost:6000/context/referenceType',
      '@type': 'http://schema.org/Text',
    },
    isEssentialPartOf: 'http://localhost:6000/context/isEssentialPartOf',
    isOptionalPartOf: 'http://localhost:6000/context/isOptionalPartOf',
    needsAsPrerequisite: 'http://localhost:6000/context/needsAsPrerequisite',
    isSimilarTo: 'http://localhost:6000/context/isSimilarTo',
    isSameAs: 'http://localhost:6000/context/isSameAs',
  },
}
